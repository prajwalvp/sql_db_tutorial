...
CREATE TABLE `Targets` (
  ...
  `ra` text NOT NULL COMMENT "Right Ascension hhmmss- need not be too accurate",
  `dec` text NOT NULL COMMENT "Declination ddmmss - need not be too accurate",  
  `region` text NOT NULL COMMENT "Name of specific region of sky (if valid) e.g. globular cluster",
  `semi_major_axis` text NOT NULL COMMENT "length of semi major axis of elliptic target region",
  `semi_minor_axis` text NOT NULL COMMENT "length of semi minor axis of elliptic target region",
  `position_angle` text  NOT NULL COMMENT "angle of source system with respect to plane of sky; edge on is 90 deg",
...
--
-- Table structure for table `Beamformer Configuration`
--
...
--
-- Table structure for table `Data Products`
--
...
--
-- Table structure for table `Processing_Pivot`
--
